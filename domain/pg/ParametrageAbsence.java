...
@Entity
@Table(name="pg_ParametrageAbsence")
  public class ParametrageAbsence  implements Serializable{
	
	private static final long serialVersionUID = 1L;
	
	public ParametrageAbsence () {	
	}
   ...
   private ParametrageModuleGlobale  parametrageModuleGlobale ;
	...
	@OneToMany(mappedBy = "parametrageAbsence")
    ...
    @OneToOne(mappedBy = "parametrageAbsence")
