...
@Entity
@Table(name="pg_ParametrageFrais")
  public class ParametrageFrais  implements Serializable{
	
	private static final long serialVersionUID = 1L;
	
	public ParametrageFrais () {	
	}
	...
	@OneToMany(mappedBy = "parametrageFrais")
