...
@Entity
@Table(name="pg_ParametrageGTA")
  public class ParametrageGTA  implements Serializable{
	
	private static final long serialVersionUID = 1L;
	
	public ParametrageGTA () {	
	}
	...
	@OneToMany(mappedBy = "parametrageGTA")
	...
	@OneToOne(mappedBy = "parametrageGTA")
