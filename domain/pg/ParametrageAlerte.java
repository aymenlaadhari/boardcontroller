...
@Entity
@Table(name="pg_ParametrageAlerte")
  public class ParametrageAlerte  implements Serializable{
	
	private static final long serialVersionUID = 1L;
	
	public ParametrageAlerte () {	
	}
	...
	@OneToMany(mappedBy = "parametrageAlerte")
	...
	@OneToOne(mappedBy = "parametrageAlerte")
