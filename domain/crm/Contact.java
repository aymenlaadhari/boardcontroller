...
public class Contact implements Serializable {
	...
	private List<CordonneeContact> cordonneeContacts;
	...
	public List<CordonneeContact> getCordonneeContacts() {
		return cordonneeContacts;
	}

	public void setCordonneeContacts(List<CordonneeContact> cordonneeContacts) {
		this.cordonneeContacts = cordonneeContacts;
	}
