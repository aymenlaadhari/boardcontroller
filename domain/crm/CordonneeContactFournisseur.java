 ...
 */
@Entity
@Table(name="crm_crdnrh02")
public class CordonneeContactFournisseur implements Serializable {
	...
	private ContactFournisseur contacts;
	...
	public CordonneeContactFournisseur() {
		super();
	}   
	...
	@ManyToOne
	public ContactFournisseur getContacts() {
		return contacts;
	}
	public void setContacts(ContactFournisseur contacts) {
